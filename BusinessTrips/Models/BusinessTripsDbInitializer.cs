...
namespace BusinessTrips.Models
{
    public class BusinessTripsDbInitializer : DropCreateDatabaseIfModelChanges<BusinessTripsContext>
    {
        ...
        {
            Passage psg1 = new Passage { Id = 1, DateofDeparture = new System.DateTime(2017, 10, 10, 9, 00, 00), DateofArrival = new System.DateTime(2017, 10, 12, 12, 10, 00),
                Transport = "avto", DestinationPoint = "Kemerovo", DeparturePoint = "Tomsk" };
            ...
            DutyJourney dj2 = new DutyJourney
            {
                Id = 1,
                City = "Tomsk",
                Country = "Russia",
